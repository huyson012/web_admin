...
CKEDITOR.event||(CKEDITOR.event=function(){},CKEDITOR.event.implementOn=function(b){
    ...
    a.prototype={
        getListenerIndex:function(a){
            for(var b=0,d=this.listeners;b<d.length;b++)if(d[b].fn==a)return b;return-1
            }
        };
return{
    define:function(a,e){
...
(function(){
    ...
    CKEDITOR.tools={
        arrayCompare:function(a,b){
            ...
            for(var e=0;e<a.length;e++)if(a[e]!=b[e])return false;return true
            },
        clone:function(a){
            var b;
            ...
            b=new a.constructor;
            for(e in a)b[e]=this.clone(a[e]);return b
            },
    ...
    buildStyleHtml:function(a){
        for(var a=[].concat(a),b,e=[],c=0;c<a.length;c++)if(b=a[c])/@import|[{}]/.test(b)?e.push("<style>"+b+"</style>"):e.push('<link type="text/css" rel=stylesheet href="'+b+'">');return e.join("")
        },
...
normalizeCssText:function(a,b){
    ...
    for(d in g)c.push(d+":"+g[d]);c.sort();
...
CKEDITOR.dom.element.clearMarkers=function(b,c,a){
    ...
    for(d in f)c.removeCustomData(d);c.removeCustomData("list_marker_names");
    if(a){
...
removeStyle:function(a){
    ...
    if(!b.removeProperty&&(a=="border"||a=="margin"||a=="padding")){
        ...
        for(var b=[],g=0;g<c.length;g++)if(d)for(var k=0;k<d.length;k++)b.push([a,c[g],d[k]].join("-"));else b.push([a,c[g]].join("-"));for(a=0;a<b.length;a++)this.removeStyle(b[a])
            }else{
...
(function(){
    ...
    var i={
    elements:{}
},t=c=="html",q=CKEDITOR.tools.extend({},u),n;
for(n in q)"#"in p[n]||delete q[n];for(n in q)i.elements[n]=l(t,b.config.fillEmptyBlocks!==false);i.root=l(t);
...
"tbody"],u=CKEDITOR.tools.extend({},p.$blockLimit,p.$block),r={
    ...
    elements:{$:function(a){var b=a.attributes;if(b){if(b["data-cke-temp"])return false;for(var c=["name","href","src"],d,m=0;m<c.length;m++){d="data-cke-saved-"+c[m];d in b&&delete b[c[m]]}}return a},
        table:function(a){a.children.slice(0).sort(function(a,
        b){
        var c,d;
...
insertElement:function(b){
    ...
    for(var c=
        ...
        if(!o.checkReadOnly()){
            ...
            k=!p&&b||b.clone(1);
            var F,u;
            if(i)for(;(F=o.getCommonAncestor(0,1))&&(u=CKEDITOR.dtd[F.getName()])&&(!u||!u[n]);)if(F.getName()in CKEDITOR.dtd.span)o.splitElement(F);
                else if(o.checkStartOfBlock()&&o.checkEndOfBlock()){
                o.setStartBefore(F);
                o.collapse(true);
                F.remove()
                }else o.splitBlock(e==CKEDITOR.ENTER_DIV?"div":"p",
                c.editable());o.insertNode(k);
            B||(B=k)
            }
        }
    if(B){
    ...
    if(a.collapsed){
        ...
        if(!g){
            ...
            for(var g=C(this,c),q=g.hasAttributes(),s=k.getCommonAncestor(),p={},r={},u={},x={},A,B,F;g&&s;){
                if(s.getName()==d){
                    for(A in e.attributes)if(!x[A]&&(F=s.getAttribute(B)))g.getAttribute(A)==F?r[A]=1:x[A]=1;for(B in e.styles)if(!u[B]&&(F=s.getStyle(B)))g.getStyle(B)==F?p[B]=1:u[B]=1
                        }
                        s=s.getParent()
                }
                for(A in r)g.removeAttribute(A);for(B in p)g.removeStyle(B);q&&!g.hasAttributes()&&(g=
                null);
            if(g){
...
function f(a){
    ...
    if(a=(new CKEDITOR.dom.elementPath(b,a.root)).contains(this.element,1)){
        ...
        c=b.attributes;
        if(c)for(var d in c)a.removeAttribute(d,c[d]);if(b.styles)for(var e in b.styles)b.styles.hasOwnProperty(e)&&a.removeStyle(e)
            }
        }
function d(a){
...
function C(a,b,c){
    ...
    if(d)for(var e in d)a.setAttribute(e,d[e]);c&&a.setAttribute("style",c);
    return a
    }
    function i(a,b){
...
(function(){
    var b={},c;
    for(c in CKEDITOR.dtd.$blockLimit)c in CKEDITOR.dtd.$list||(b[c]=1);var a={};
    
    for(c in CKEDITOR.dtd.$block)c in CKEDITOR.dtd.$blockLimit||c in CKEDITOR.dtd.$empty||(a[c]=1);CKEDITOR.dom.elementPath=function(c,e){
...
CKEDITOR.dom.elementPath.prototype={
    compare:function(b){
        ...
        for(var a=0;a<c.length;a++)if(!c[a].equals(b[a]))return false;return true
        },
    contains:function(b,c,a){
        ...
        if(a){
            ...
            for(c=0;c<d;c++)if(f(e[c]))return e[c];return null
        },
...
CKEDITOR.plugins.add("dialogui",{
    ...
    for(var a in b)(s.test(a)||"title"==a||"type"==a)&&delete b[a];return b
    };
...
textInput:function(b,a,d){
    ...
    CKEDITOR.ui.dialog.labeledElement.call(this,b,a,d,function(){
        ...
        for(var f in c)b.push(f+'="'+c[f]+'" ');b.push(" /></div>");
        return b.join("")
        })
    }
},
textarea:function(b,a,d){
    if(!(3>arguments.length)){
        ...
        CKEDITOR.ui.dialog.labeledElement.call(this,b,a,d,function(){
            ...
            for(b in f)a.push(b+'="'+CKEDITOR.tools.htmlEncode(f[b])+'" ');a.push(">",CKEDITOR.tools.htmlEncode(e._["default"]),"</textarea></div>");
            return a.join("")
            })
        }
    },
    ...
    if(!(3>arguments.length)){
        ...
        CKEDITOR.ui.dialog.uiElement.call(this,b,a,d,"span",null,null,function(){
            var c=CKEDITOR.tools.extend({},a,{
                ...
                },true),f=[],d=CKEDITOR.tools.getNextId()+"_label",g={
...
(function(){
    function p(){
        ...
        function u(){
        for(var a=this._.tabIdList.length,b=CKEDITOR.tools.indexOf(this._.tabIdList,this._.currentTabId),c=b+1;c<b+a;c++)if(this._.tabs[this._.tabIdList[c%a]][0].$.offsetHeight)return this._.tabIdList[c%a];return null
        }
        function q(a,b){
...
CKEDITOR.dialog=function(a,b){
    ...
    if(l==
        ...
        if(9==c||c==CKEDITOR.SHIFT+9)c=c==CKEDITOR.SHIFT+9,l._.tabBarMode?(c=c?p.call(l):u.call(l),l.selectPage(c),l._.tabs[c][0].focus()):e(c?-1:1),o=1;
            ...
            hide:!0
            }).hide&&this.hide(),i=1;else return;
        g(b)
        }
    }
function g(a){
...
var W={
    ...
    for(var e=0,d;d=a[e];e++)if(d.id==b||c&&d[c]&&(d=z(d[c],b,c)))return d;return null
...
hbox:function(a,b,c,e,d){
    if(!(4>arguments.length)){
        this._||(this._={});
        var g=this._.children=b,f=d&&d.widths||null,k=d&&d.height||null,m,j={
            role:"presentation"
        };
    ...
    CKEDITOR.dialog.validate={
        functions:function(){
            ...
            return function(){
                ...
                for(g=0;g<a.length;g++)if("function"==typeof a[g])e.push(a[g]);else break;g<a.length&&"string"==typeof a[g]&&(c=a[g],g++);
        ...
        exec:function(g){
            ...
            if(a==CKEDITOR.TRISTATE_OFF){
                ...
                for(b=null;0<e.length;){
                    ...
                    b.replace(a)
                    }else e.push(a);c=g.document.createElement("blockquote");
                ...
                e=[];
                for(d={};
                    0<b.length;)f=b.shift(),c=f.getParent(),f.getPrevious()?f.getNext()?(f.breakParent(f.getParent()),e.push(f.getNext())):f.remove().insertAfter(c):f.remove().insertBefore(c),c.getCustomData("blockquote_processed")||
...
function k(a,c){
    ...
    if(!d.getById("cke_pastebin")){
        var h=b.getSelection(),o=h.createBookmarks(),i=new CKEDITOR.dom.element(j.is("body")&&!CKEDITOR.env.ie&&
            !CKEDITOR.env.opera?"body":"div",d);
...
function o(){
    ...
    if("wysiwyg"==b.mode)switch(a.data.keyCode){
        case CKEDITOR.CTRL+86:case CKEDITOR.SHIFT+45:
            ...
            break;
        case CKEDITOR.CTRL+88:case CKEDITOR.SHIFT+46:
        ...
        var e,h=function(c,d){
            ...
            switch(d){
                case 9:case CKEDITOR.SHIFT+9:
                    ...
                    1],b.items.length)for(c=b.items[e?b.items.length-1:0];c&&!c.focus;)(c=e?c.previous:c.next)||(b=0);c&&c.focus();
                    return!1;
                case g?37:
                    39:case 40:
                    b=c;
...
x.prototype={
    exec:function(c){
        ...
        k=[];
        for(e=0;e<b.contents.length;e++)if(l=b.contents[e],(l=l.getAscendant("li",!0))&&!l.getCustomData("list_item_processed"))k.push(l),CKEDITOR.dom.element.setMarker(d,l,"list_item_processed",!0);for(var l=b.root.getDocument(),p=void 0,o=void 0,e=0;e<k.length;e++){
        ...
        }else this.state==CKEDITOR.TRISTATE_ON&&r[d.root.getName()]&&C.call(this,c,d,h);for(l=0;l<n.length;l++)A(n[l]);
...
(function(){
    function p(d,i){
        ...
        ol:1,
        ul:1
    },t=CKEDITOR.dom.walker.whitespaces(!0),u=CKEDITOR.dom.walker.bookmark(!1,!0);
    p.prototype={
        context:"p",
...
function q(){
    ...
    if(8<=CKEDITOR.document.$.documentMode){
        ...
        var c=[],d;
        for(d in CKEDITOR.dtd.$removeEmpty)c.push("html.CSS1Compat "+d+"[contenteditable=false]");a.push(c.join(",")+"{display:inline-block}")
    ...
    function N(a,b,d){
        ...
        p(d,{
            ...
            place:function(){
                ...
                for(var Q in g)g[Q]=CKEDITOR.tools.cssLength(g[Q]);this.setStyles(g)
                },
            look:function(a){
                if(this.oldLook!=a){
...
function u(a,b){
    ...
    else if(b.y>f.size.bottom-e&&b.y<f.size.bottom+1)i=!0;else return null;
    if(o(f)||
...
filter:function(a,h){
    for(var e=a._.removeFormatFilters||[],f=0;f<e.length;f++)if(!1===e[f](h))return!1;return!0
    }
};
    ...
    function k(a,c){
        ...
        function a(){
            ...
            if(!("undefined"!=typeof d.instances[b.name]||null!=d.instances[b.name])){
                ...
                if("object"==typeof a)for(var f in a)c[f]=a[f];d.getControlId(b)&&(c.id=d.getControlId(b));
    ...
    CKEDITOR.plugins.add("stylescombo",{
        ...
        init:function(d){
            ...
            onOpen:function(){
                ...
                for(var b in h){
                    var f=h[b],e=f.type;
                    e==CKEDITOR.STYLE_BLOCK&&
                    !a.isContextFor(f.element)?this.hideItem(b):(f.checkActive(a)?this.mark(b):e==CKEDITOR.STYLE_OBJECT&&!f.checkApplicable(a)&&(this.hideItem(b),c[e]--),c[e]++)
                    }
